...
/**
 * Данный клас подходит под паттер Registry (потому что он так и называется - шутка)
 * Имеет статичные методы - вызывается и в точке входа и в контроллерах (инкапсулирует в себе некую логику) - по сути гетеры и сеттеры.
 */